...
if app.args.eddy:
    ...
    if app.args.rpe_none:
        call('dwipreproc -eddyqc_all ' + path2qc + ' -eddy_options " --repol --data_is_shelled" -nthreads 16 -force -rpe_none -pe_dir '
        ...
        call('dwipreproc -eddyqc_all ' + path2qc + ' -eddy_options " --repol --data_is_shelled" -rpe_pair -se_epi -nthreads 16 -force rpepair.mif -pe_dir '
                     + app.args.pe_dir + ' working.mif dwiec.mif',shell=True)
        ...
        call('dwipreproc -eddyqc_all ' + path2qc + ' -eddy_options " --repol --data_is_shelled" -nthreads 16 -force -rpe_all -pe_dir '
                     + app.args.pe_dir + ' dwipe_rpe.mif dwiec.mif',shell=True)
        run.function(os.remove, 'tmp.mif')
    elif app.args.rpe_header:
        call('dwipreproc -eddyqc_all ' + path2qc + ' -eddy_options " --repol --data_is_shelled" -nthreads 16 -force -rpe_header working.mif dwiec.mif',shell=True
                    )
